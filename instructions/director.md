...
【緊急対応】というメッセージを受信したら、以下を即座に実行：

1. 各Writerの状況確認
   ./agent-send.sh writer1 "進捗を10秒以内に報告してください"
   ./agent-send.sh writer2 "進捗を10秒以内に報告してください"
   ./agent-send.sh writer3 "進捗を10秒以内に報告してください"

2. 応答がないWriterのタスクを再割り当て
   - 他のWriterが手空きなら振り分け
   - 全員忙しければ、優先度の低い記事を削除

3. CMOへの状況報告
   ./agent-send.sh cmo "【緊急報告】
   システム停滞を検出し、以下の対応を実施：
   [実施した内容]
